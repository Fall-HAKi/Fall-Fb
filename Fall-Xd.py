...
for xcTeam in range(1000):
	rr = random.randint
	rc = random.choice
	ngentot1 = f"Dalvik/2.1.0 (Linux; U; Android 9.0.0; vivo 9593 Build/BBS77F.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV//{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.orca;FBLC/en_US;FBBV/{str(rr(200000000,299999999))};FBCR/null;FBMF/vivo;FBBD/vivo;FBDV/vivo BBS77F;FBSV/9.0.0;FBCA/armeabi-v7a:armeabi;FBDM/"+"{density=3.0,width=1080,height=1920}]"
	if ngentot1 in ngentott:pass
	else:ngentott.append(ngentot1)
	ngentot2 = f"Dalvik/2.1.0 (Linux; U; Android 10.0.0 ; SM-G935T Build/UCH21G.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.mlite;FBLC/en_US;FBBV/{str(rr(200000000,299999999))};FBCR/Airtel;FBMF/Facebook;Facebook/lge;FBBD/SM-G935T;FBDV/SM-G935T;FBSV/10.0.0 ;FBCA/armeabi-v7a:armeabi;FBDM/"+"{density=2.75,width=1080,height=2179};FB_FW/1;]"
	if ngentot2 in ngentott:pass
	else:ngentott.append(ngentot2)
	ngentot3 = f"Dalvik/2.1.0 (Linux; U; Android 6; Infinix X99 Build/QP1A.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.orca;FBLC/th_TH;FBBV/{str(rr(200000000,299999999))};FBCR/TRUE-H;FBMF/Infinik;FBBD/Infinik;FBDV/Infinik X99;FBSV/6;FBCA/armeabi-v7a:armeabi;FBDM/"+"{density=2.0,width=1424,height=720};FB_FW/1;] FBBK/1)"
	if ngentot3 in ngentott:pass
	else:ngentott.append(ngentot3)
	ngentot4 = f"Davik/2.1.0 (Linux; U; Android 10; CLT-AL00 Build/HUAWEICLT-AL00.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.mlite;FBLC/in_ID;FBBV/{str(rr(200000000,299999999))};FBCR/null;FBMF/vivo;FBBD/vivo;FBDV/vivoV3Max;FBSV/5.0.0;FBCA/armeabi-v7a:armeabi;FBDM/"+"{density-3.0,width=1080,height=1920};]"
